...
namespace TeduCoreApp.Application.Implementation
{
    public class ProductCategoryService : IProductCategoryService
    {
        ...
        {
            return _productCategoryRepository.FindAll().OrderBy(x => x.ParentId == parentId && x.Status == Status.Active)
                .ProjectTo<ProductCategoryViewModel>().ToList();
        }
        ...
        {
            var productCategory = _productCategoryRepository.FindSingle(x => x.Id == productCategoryVm.Id);
